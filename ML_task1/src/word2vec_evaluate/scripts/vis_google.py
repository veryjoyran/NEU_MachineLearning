...
words_to_visualize_100 = all_words[:100]

words_to_visualize = ['king', 'queen', 'man', 'woman', 'paris', 'france', 'computer', 'keyboard', 'dog', 'cat']

visualize_tsne(model,"GoogleNews-vectors-negative300",words_to_visualize)
visualize_tsne(model,"GoogleNews-vectors-negative300",words_to_visualize_100)
